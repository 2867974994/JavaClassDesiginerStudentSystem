...
public class AccountEvent implements ActionListener{
	...
	void Jbtton()  {
		...
		if(nameT==true) {
			...
			//如果确认密码和密码是不一样的
			JOptionPane.showMessageDialog(null, "密码输入不一致", "注册消息",JOptionPane.WARNING_MESSAGE);
		}else {
			//姓名文本
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "当前账号已经存字", "注册消息",JOptionPane.WARNING_MESSAGE);
